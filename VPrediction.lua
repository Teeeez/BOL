...
local UPDATE_PATH = "/Teeeez/BoL/blob/master/VPrediction.lua".."?rand="..math.random(1,10000)
...
if AUTOUPDATE then
	local ServerData = GetWebResult(UPDATE_HOST, "/Teeeez/BoL/blob/master/VPrediction.version")
	if ServerData then
