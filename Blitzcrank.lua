...
local SOURCELIB_URL = "https://raw.github.com/Teeeez/BOL/edit/master/SourceLib.lua"
...
if AUTOUPDATE then
	 SourceUpdater(SCRIPT_NAME, version, "raw.github.com", "/Teeeez/BoL/master/"..SCRIPT_NAME..".lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "/Teeeez/BoL/master/version/"..SCRIPT_NAME..".version"):CheckUpdate()
end

local RequireI = Require("SourceLib")
RequireI:Add("vPrediction", "https://raw.github.com/Teeeez/BOL/edit/master/VPrediction.lua")
RequireI:Add("SOW", "https://raw.github.com/Teeeez/BOL/edit/master/SOW.lua")
RequireI:Check()
